    ...
    <div className="start-journey">
      ...
      <div className="stake-community">
        <div className="stake">
          ...
          <p>
            The smart contract code has been successful audited by 2 independent
            companies{" "}
          </p>
        </div>
        <div className="stake">
          ...
          <p>
            In the code sets the highest APR among all yield farms on BSC, rules
            of a smart contract can’t be changed, nothing can affect the amount
            of income.{" "}
          </p>
        </div>
        <div className="stake">
          ...
          <p>
            BNB Stake 24/7 provides you our knowledgable and experienced
            customer support team in Telegram{" "}
          </p>
        </div>
      </div>
    </div>
